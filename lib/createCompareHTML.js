const createCompareHTML = (input) => {
  ...
  <html>
    ...
    <body>
      <div id="top-logo"><img src="http://zillberrycom.fatcow.com/react-prime/prime_light_sm.png" width="200"></div>
      <div id="iframe-wrapper">
        <div id="csr-div">
          ...
          <div>
            <div id="button1" onClick='document.getElementById("csr-report-iframe").src="./csr-report.html";window.scrollBy(0, 600);' className="btn purple">VIEW
              REPORT
            </div>
        ...
        <div id="ssr-div">
          ...
          <div>
            <div id="button2" onClick='document.getElementById("ssr-report-iframe").src="./ssr-report.html";window.scrollBy(0, 600);' className="btn purple">VIEW
              REPORT
            </div>
