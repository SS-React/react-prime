...
inquirer.prompt(cliQuestions).then((answers) => {
  ...
  console.log(chalk.red(`Run 'npm run prime:compare' to see a comparison of your website`));
  console.log(chalk.red(`Or, run 'npm run prime:server' to see an SSR version of your app\n\n`));
});
