...
inquirer.prompt(cliQuestions).then((answers) => {
  ...
  console.log(chalk.rgb(0, 127, 255).bold(`\n---------------Completed---------------\n`));
  console.log(chalk.rgb(0, 127, 255).bold(`Run 'npm run prime:compare' to see a comparison of your website`));
  console.log(chalk.rgb(0, 127, 255).bold(`Or, run 'npm run prime:server' to see an SSR version of your app\n\n`));
});